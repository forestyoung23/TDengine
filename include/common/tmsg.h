...
typedef enum _mgmt_table {
  ...
  TSDB_MGMT_TABLE_USER_REDS,
  TSDB_MGMT_TABLE_TABLE_REDS,
  TSDB_MGMT_TABLE_MAX,
} EShowType;
...
#define TSDB_ALTER_TABLE_UPDATE_COLUMN_RD_LEVEL 14
#define TSDB_ALTER_TABLE_UPDATE_COLUMN_RD_RULE  15
#define TSDB_ALTER_TABLE_UPDATE_COLUMN_RD_RANGE 16
...
typedef enum EColumnOptionType {
  COLUMN_OPTION_COMMENT = 0x1,
  COLUMN_OPTION_ENCODE = 0x2,
  COLUMN_OPTION_COMPRESS = 0x4,
  COLUMN_OPTION_LEVEL = 0x8,
  COLUMN_OPTION_PRIMARYKEY = 0x10,
  COLUMN_OPTION_READ_LEVEL = 0x20,
  COLUMN_OPTION_READ_RULE = 0x40,
  COLUMN_OPTION_READ_RANGE = 0x80,
} EColumnOptionType;
...
typedef enum ENodeType {
  ...
  QUERY_NODE_SHOW_USER_REDS_STMT,
  QUERY_NODE_SHOW_TABLE_REDS_STMT,  
  ...
  QUERY_NODE_LOGIC_PLAN_VALUE_MASK_FUNC,
  ...
  QUERY_NODE_PHYSICAL_PLAN_VALUE_MASK,
} ENodeType;
