...
#define TSDB_MIN_READ_RANGE 0
#define TSDB_MAX_READ_RANGE INT32_MAX
#define TSDB_DEFAULT_READ_RANGE 0
#define TSDB_MIN_READ_LEVEL 0
#define TSDB_MAX_READ_LEVEL 2
#define TSDB_DEFAULT_READ_LEVEL 0
#define TSDB_MIN_READ_RULE 0
#define TSDB_MAX_READ_RULE 1
#define TSDB_DEFAULT_READ_RULE 0
